...
function evaluate(answers){
  ...
  var foo = [3, 4, 10, 9,	11,	5, 18, 17, 13, 12, 1,	16,	2, 14, 8,	15,	6, 7, 2, 8, 16, 14, 13, 3, 15, 11, 12, 5, 1, 18, 4, 10, 7, 17, 6, 9];
  ...
  var stdDv2 = [2.4, 2.4, 2.7, 3.3, 6.4,  6.3, 1.8, 2.2, 3.1, 4.1, 3.6, 2.1, 2.3, 2.4, 3.1, 2.6,	3.0,	3.2,	2.5,	2.9,	3.1,	2.5,	2.7,	2.9,	2.7,	2.6,	2.4,	2.9,	2.6,	2.3,	2.7,	2.9,	2.7,	3.0,	2.7,	2.7];
  var ansEv = 0;
  var shittyFactor = 0;

  for(i=0; i<answers.length;i++){
    ansEv = parseFloat((Math.abs((answers[i]-foo[i]))/stdDv2[i]));
    shittyFactor += ansEv;
  }
